...
%		- 论文内容：/latex目录下，包含封面(cover.tex)、正文(Chapter.tex)、
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\fancypagestyle{djtu}{
	...
	\fancyhead[CE]{\zihao{-5} \heiti 大连交通大学 2026 届本科生综合毕业设计外文翻译}  % 偶数页眉，居中，小五，黑体 
	\fancyhead[CO]{\zihao{-5} \heiti 大连交通大学 2026 届本科生综合毕业设计外文翻译}  % 奇数页眉，居中，小五，黑体
	}
