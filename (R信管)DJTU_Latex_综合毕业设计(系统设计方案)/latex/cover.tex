...
%======================个人信息录入=================================
% 题目：综合毕业设计题目
\newcommand\thesisTitle{基于动态分组的过程性考核管理系统的分析与实现} 
   			
% 姓名：学生姓名
\newcommand\thesisAuthor{国士林} 	
		   
% 专业班级
\newcommand\thesisClass{信息管理与信息系统＋软件工程 2021-2}	
...
% 完成时间
\newcommand\thesisDate{2026年1月16日}
...
%   \vspace*{1.5\baselineskip}
   ...
   {\songti \zihao{-0} \bfseries (系统设计方案)}
   \vspace*{2.0\baselineskip}


   % 题目位置
   {\heiti \zihao{3} 题 \quad \quad 目\underline{\makebox[13.5cm][c]{\zihao{3} \thesisTitle}}}   
   \vspace*{2.5\baselineskip}
    ...
    % 第一行：学生姓名 
    {\zihao{4} 学生姓名}   \underline{\makebox[29.25em][c]{\zihao{4} \thesisAuthor}}
