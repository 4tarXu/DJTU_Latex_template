% -*- coding=utf-8 -*-
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	大连交通大学信管综合毕设latex模版——综合毕业设计(系统设计方案)
%	创建日期：2025年4月19日
%	最后修改日期：2025年11月30日
%	创建人：管理科学与工程系 王晗、徐世达
...
\usepackage{array} % 表格列宽
\usepackage{makecell}
\usepackage{lipsum}
%==========================页面边距设置=============================
\usepackage[a4paper,left=25mm,right=25mm,top=25mm,bottom=25mm,headheight=15mm,headsep=4mm ,footskip=10mm]{geometry}	
...
\renewcommand{\headrule}{%
  \hrule width\headwidth height 0.75pt% 细线（0.4磅）
 \vskip 0.5pt% 间距
}
\makeatother
...
\fancypagestyle{djtu}{
	...
	\fancyhead[CE]{\zihao{-5} \heiti 大连交通大学 2026 届本科生综合毕业设计（系统设计方案）}  % 偶数页眉，居中，小五，黑体 
	\fancyhead[CO]{\zihao{-5} \heiti 大连交通大学 2026 届本科生综合毕业设计（系统设计方案）}  % 奇数页眉，居中，小五，黑体
	}
...
\renewcommand{\contentsname}{目\quad 录\\[1em]}		% “目录”两字之间空X格

\titlecontents{chapter}
[0em] % 缩进量
{\songti\zihao{-4} } % 控制字体字号
{\thecontentslabel\hspace{0.5em}} % 控制章节编号和名称的距离 
{} 
{\titlerule*[3pt]{.}\hspace{-1em}\contentspage} % 控制引导点密度,这里引入\hspace{-1em}的功能是防止页码和引导点之间有空格

\titlecontents{section}
[1em] % 缩进量
{\songti\zihao{-4} \linespread{1}\selectfont} % 控制字体字号
...
\defbibheading{bibliography}[\refname]{%
    \chapter*{ \heiti \zihao{4} #1}% 正常字体，不加粗
