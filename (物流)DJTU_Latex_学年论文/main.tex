...
%==========================页面边距设置=============================
\usepackage[a4paper,left=25mm,right=25mm,top=25mm,bottom=25mm,headheight=15mm,headsep=4mm ,footskip=1.75mm]{geometry}	
...
\fancypagestyle{djtu}{
	...
	\fancyhead[CE]{\zihao{-5} \heiti 大连交通大学2022级学年论文}  % 偶数页眉，居中，小五，黑体 
	\fancyhead[CO]{\zihao{-5} \heiti 大连交通大学2022级学年论文}  % 奇数页眉，居中，小五，黑体
	}
 \fancypagestyle{plain}{
 	\fancyhf{}		% 清空所有定义
 	\fancyfoot[CE,CO]{\zihao{-5} \songti \thepage}      % 设置页脚为当前页码，居中,小五，数字1，2，3等
 	\fancyhead[CE]{\zihao{-5} \heiti 大连交通大学学年论文}  % 偶数页眉，居中，小五，黑体 
 	\fancyhead[CO]{\zihao{-5} \heiti 大连交通大学学年论文}  % 奇数页眉，居中，小五，黑体
     }
...
{\thecontentslabel\hspace{1em}} % 控制章节编号和名称的距离 
{} 
{\titlerule*[6pt]{.}\hspace{-1em}\contentspage} % 控制引导点密度,这里引入\hspace{-1em}的功能是防止页码和引导点之间有空格
