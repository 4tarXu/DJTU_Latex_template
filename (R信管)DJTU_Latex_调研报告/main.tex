...
%		- 论文内容：/latex目录下，包含封面(cover.tex)和正文(Chapter.tex)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%=============================文档类型=============================
\documentclass[twoside, 12pt,openany, AutoFakeBold]{ctexbook}	
...
\fancypagestyle{djtu}{
	...
	\fancyhead[CE]{\zihao{-5} \heiti 大连交通大学 2026 届本科生综合毕业设计调研报告}  % 偶数页眉，居中，小五，黑体 
	\fancyhead[CO]{\zihao{-5} \heiti 大连交通大学 2026 届本科生综合毕业设计调研报告}  % 奇数页眉，居中，小五，黑体
	}
...
{} 
{\titlerule*[0.5pc]{.}\hspace{-1em}\contentspage} % 控制引导点密度,这里引入\hspace{-1em}的功能是防止页码和引导点之间有空格
